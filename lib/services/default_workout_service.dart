...
class DefaultWorkoutService {
  ...
  DefaultWorkoutService({required WorkoutTemplateService templateService})
    ...
    return [
      {
        ...
        'description':
            'Perfect for newcomers to fitness - low intensity, full body workout',
      ...
      },
      {
        ...
        'description':
            'Long form workout to build stamina and cardiovascular health',
      ...
      },
      {
        'name': 'Power Hour',
        'description':
            'High-intensity strength and conditioning for experienced athletes',
      ...
      },
      {
        ...
        'description':
            'Low-intensity movement for active recovery and mobility',
        'format': WorkoutFormat.forTime,
        'intensity': IntensityLevel.low,
        'targetDuration': 25,
        'preferredCategories': [
      ...
      },
      {
        'name': 'Core Crusher',
        'description':
            'Focused core strengthening workout for all fitness levels',
        'format': WorkoutFormat.forTime,
        'intensity': IntensityLevel.medium,
        'targetDuration': 15,
        'preferredCategories': [
  ...
  Future<List<String>> addSelectedDefaultWorkouts(
    ...
    try {
      for (final workoutName in selectedWorkoutNames) {
        ...
        if (workoutConfig.isNotEmpty) {
          final templateId = await _templateService.createTemplate(
            ...
            preferredCategories:
                workoutConfig['preferredCategories'] as List<MovementCategory>?,
      ...
      _logger.i(
        'Successfully added ${addedTemplateIds.length} default workout templates',
      );
    } catch (e) {
