...
abstract class UserProgressRepository {
  ...
  Future<void> updateMovementProgress(String userId, String movementId, MovementProgress progress);
  Future<List<WorkoutResult>> getWorkoutHistory(String userId, {int? limit});
  Future<MovementProgress?> getMovementProgress(String userId, String movementId);
...
class SQLiteUserProgressRepository implements UserProgressRepository {
  ...
  Future<UserProgress?> getUserProgress(String userId) async {
    ...
    return UserProgress(
      ...
      achievements: userMap['achievements'] != null
          ? jsonDecode(userMap['achievements'] as String) as Map<String, dynamic>
          : null,
    );
  }
  ...
  @override
  Future<void> addWorkoutResult(String userId, WorkoutResult workoutResult) async {
    final db = await _dbHelper.database;
  ...
  @override
  Future<void> updateMovementProgress(String userId, String movementId, MovementProgress progress) async {
    final db = await _dbHelper.database;
  ...
  @override
  Future<List<WorkoutResult>> getWorkoutHistory(String userId, {int? limit}) async {
    final db = await _dbHelper.database;
  ...
  @override
  Future<MovementProgress?> getMovementProgress(String userId, String movementId) async {
    final db = await _dbHelper.database;
  ...
  Map<String, dynamic> _userProgressToMap(UserProgress userProgress) {
    return {
      ...
      'goals': userProgress.goals != null ? jsonEncode(userProgress.goals) : null,
      'achievements': userProgress.achievements != null ? jsonEncode(userProgress.achievements) : null,
    };
  }

  Map<String, dynamic> _workoutResultToMap(String userId, WorkoutResult result) {
    return {
      'user_id': userId,
  ...
  WorkoutResult _workoutResultFromMap(Map<String, dynamic> map) {
    return WorkoutResult(
      ...
      performanceMetrics: map['performance_metrics'] != null
          ? jsonDecode(map['performance_metrics'] as String) as Map<String, dynamic>
          : null,
      notes: map['notes'] as String?,
    );
  }

  Map<String, dynamic> _movementProgressToMap(String userId, MovementProgress progress) {
    return {
      'user_id': userId,
  ...
  MovementProgress _movementProgressFromMap(Map<String, dynamic> map) {
    return MovementProgress(
      ...
      personalRecords: map['personal_records'] != null
          ? jsonDecode(map['personal_records'] as String) as Map<String, dynamic>
          : null,
    );
  }
} 